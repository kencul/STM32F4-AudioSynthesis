...
| Directory | Contents |
|-----------|----------|
| `App/` | All custom application code: DSP, synthesis engine, MIDI handling, UI |
| `Core/` | Auto-generated by STM32CubeMX: HAL init, clock config, interrupt handlers |
| `Drivers/` | Vendored CMSIS and STM32F4xx HAL |
| `Middlewares/` | Vendored STM32 USB Device Library |
